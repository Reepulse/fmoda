...
class __TwigTemplate_c28e1ce9c0bab9d19a9a36897583cbf0fde844f7320999b7d0a276737d3bf65b extends Twig_Template
{
...
";
    ...
    <script>
        ...
        echo "',
            locale: '";
        // line 37
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "request", array()), "query", array()), "get", array(0 => "locale"), "method"), "html", null, true);
        echo "',
            selected: '";
        // line 38
        echo twig_escape_filter($this->env, ((("modules" == $this->getAttribute($this->getAttribute($this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "request", array()), "query", array()), "get", array(0 => "type"), "method"))) ? (null) : ($this->getAttribute($this->getAttribute($this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "request", array()), "query", array()), "get", array(0 => "selected"), "method"))), "html", null, true);
        echo "',
            domainsTreeUrl: '";
        // line 39
...
($context["app"] ?? $this->getContext($context, "app")), "request", array()), "query", array()), "get", array(0 => "lang"), "method"), "type" => $this->getAttribute($this->getAttribute($this->getAttribute(        // line 41
($context["app"] ?? $this->getContext($context, "app")), "request", array()), "query", array()), "get", array(0 => "type"), "method"), "selected" => $this->getAttribute($this->getAttribute($this->getAttribute(        // line 42
($context["app"] ?? $this->getContext($context, "app")), "request", array()), "query", array()), "get", array(0 => "selected"), "method"))), "html", null, true);
        // line 43
        echo "',
            translationUrl: '";
        // line 44
...
{% endblock %}
", "@PrestaShop/Admin/Translations/overview.html.twig", "/home/fmodzvzg/public_html/src/PrestaShopBundle/Resources/views/Admin/Translations/overview.html.twig");
    }
}
